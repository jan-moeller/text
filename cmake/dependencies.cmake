...
if (Boost_INCLUDE_DIR)
  ...
  add_library(boost INTERFACE)
  target_include_directories(boost SYSTEM INTERFACE ${SOURCE_DIR})
...
target_include_directories(gtest      INTERFACE ${CMAKE_CURRENT_SOURCE_DIR}/googletest-release-1.8.0/googletest/include)
target_include_directories(gtest_main INTERFACE ${CMAKE_CURRENT_SOURCE_DIR}/googletest-release-1.8.0/googletest/include)


###############################################################################
# Google Benchmark
###############################################################################
add_subdirectory(${CMAKE_CURRENT_SOURCE_DIR}/benchmark-v1.2.0)
